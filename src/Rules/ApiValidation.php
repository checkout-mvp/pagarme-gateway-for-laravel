...
class ApiValidation
{
    protected static $validations = [
        ...
        'stable' => [
            ...
            'card_holder_name' => 'required_if:payments.*.payment_method,credit_card',
            'card_expiration_date' => 'required_if:payments.*.payment_method,credit_card',
            'card_number' => 'required_if:payments.*.payment_method,credit_card',
            'card_cvv' => 'required_if:payments.*.payment_method,credit_card',
            'pix_expiration_date' => 'required_if:payments.*.payment_method,pix|date_format:Y-d-m',
            ...
            'payments.*.boleto.instructions' => 'nullable|max:256',
