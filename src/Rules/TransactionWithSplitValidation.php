...
class TransactionWithSplitValidation
{
    protected static $validations = [
        ...
        'stable' => [
            ...
            'payments.*.credit_card.card.exp_month' => 'required_if:payments.*.payment_method,credit_card|between:1,12',
            'payments.*.credit_card.card.exp_year' => 'required_if:payments.*.payment_method,credit_card|date_format:Y',
